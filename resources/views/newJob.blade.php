...
@endif
             ...
             {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <select name="hours" id="inputCategory" class="form-control" value="{{ old('hours') }}">
                  <option value="Other"selected>Hours</option>
                  <option value="Middle Time">Middle Time</option>
              ...
              <div class="form-group">
                ...
                <select name="country" id="inputCountry" class="form-control" value="{{ old('country') }}">
